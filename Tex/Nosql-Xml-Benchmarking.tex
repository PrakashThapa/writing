	...
	%\section{Preliminaries}
		...
		\subsection{NoSQL database}
			...
			\paragraph{Graph database}
				Graph databases represent data as graph that means in the form of nodes and edges like in social network. They store entities and relationship between these entities. Neo4J and OrientDB are two example of these database.
